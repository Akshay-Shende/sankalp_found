    ...
    <div className="bg-gray-100 font-sans leading-relaxed tracking-wide">
      ...
      <section className="max-w-3xl mx-auto mb-12 bg-white shadow-md rounded-lg p-6">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="text" id="name" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-600"/>
          </div>
          <div>
            <label className="block text-gray-600" htmlFor="email">Email</label>
            <input type="email" id="email" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-600"/>
          </div>
          <div>
            <label className="block text-gray-600" htmlFor="message">Message</label>
            <textarea id="message" rows="4" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-600"></textarea>
          </div>
          <button type="submit" className="w-full bg-green-600 text-white px-4 py-2 rounded-md font-semibold hover:bg-green-700 transition duration-300">
            Submit
          </button>
        </form>
      </section>
      ...
      <section className="text-center">
        ...
        <div className="relative w-full h-64 bg-gray-200 rounded-md overflow-hidden">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387190.27991414944!2d-74.25986638662794!3d40.69767006484998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzLCsDQxJzUwLjciTiA3NMKwMTUnMzguOCJX!5e0!3m2!1sen!2sin!4v1618307578820!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
